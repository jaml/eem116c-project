...
head -1 part2q2_c64_1_run1.csv > part2q2_c64_3runs_merged.csv
for filename in $(ls part2q2_c64_*_run?.csv); do sed 1d $filename >> part2q2_c64_3runs_merged.csv; done
# merge all chunk size 32 run results
head -1 part2q2_c32_1_run1.csv > part2q2_c32_3runs_merged.csv
for filename in $(ls part2q2_c32_*_run?.csv); do sed 1d $filename >> part2q2_c32_3runs_merged.csv; done
